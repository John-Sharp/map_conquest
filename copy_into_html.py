...
def copy_into_hmtl(svg_path, html_template_path, output_path):
    ...
    for t in tspans:
        ...
        fo = et.SubElement(label_input_svg, 'foreignobject', {"width" : "200", "height" : "100",
        ...
        inp = et.SubElement(fo, 'input', {"id": "input_" + state_name , "type" : "text",
            "style" : "width:200; text-align:left", "class" : "answer_box"})
     
    
    
    html_tree = et.parse(html_template_path)
    ...
    html_tree.write(output_path, method="html")


copy_into_hmtl("united_states/plain_annotated.svg", "map_conquest_template.html", "map_conquest/united_states.html")
copy_into_hmtl("europe/plain_annotated.svg", "map_conquest_template.html", "map_conquest/europe.html")
